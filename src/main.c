...
void app_main() {
    adc_continuous_handle_t adc1 = NULL;
    ...
    adc_continuous_io_to_channel(34, &unit_num, &channel_num);
    ...
    while(true) {
        ret = adc_continuous_read(adc1, &result, sizeof(result), &out_length, 5000 / portTICK_PERIOD_MS);
